...
public class TestLongCodec implements Codec<Long> {
    ...
    public void realWrite(@NonNull Long value, @NonNull SlimWriter output) {
        Objects.requireNonNull(value);
        Objects.requireNonNull(output);
        output.writeLong(value);
    }
    ...
    @Override
    public int measure(@Nullable SlimBuffer input) {
        return Long.BYTES;
    }
    ...
    @Override
    public boolean fastEquals(@NonNull final Long value, @NonNull final SlimBuffer input) throws ParseException {
        Objects.requireNonNull(value);
        Objects.requireNonNull(input);
