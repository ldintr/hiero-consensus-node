...
public final class AccountIdProtoCodec implements Codec<AccountId> {
    ...
    public @NonNull AccountId realParse(
        ...
        try {
            ...
            while (input.hasRemaining()) {
                // Note: SlimBuffer.hasRemaining() won't flip to false
    ...
    public void realWrite(@NonNull AccountId data, @NonNull SlimWriter out) throws IOException {
        // [1] - id
        writeLong(out, AccountIdSchema.ID, data.id(), true);
     ...
     * @throws ParseException If parsing fails
     */
    public boolean fastEquals(@NonNull AccountId item, @NonNull final SlimBuffer input) throws ParseException {
