...
public final class ExampleVariableValue extends ExampleByteArrayVirtualValue {
    ...
    public ExampleVariableValue(final SlimBuffer in) {
        this.id = in.readInt();
    ...
    public static class ExampleVariableValueCodec implements Codec<ExampleVariableValue> {
        ...
        @Override
        public void realWrite(@NonNull ExampleVariableValue value, @NonNull SlimWriter out) {
            value.writeTo(out);
        }
        ...
        @Override
        public boolean fastEquals(@NonNull ExampleVariableValue value, @NonNull SlimBuffer in) throws ParseException {
